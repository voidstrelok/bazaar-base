...
import PedidoDetalleAdminPage from './admin/pages/PedidoDetalleAdminPage';
...
function AdminRoutes() {
  return <Routes>
    ...
    <Route path="/admin" element={<ProtectedRoute requiredRole="ADMIN"><AdminLayout /></ProtectedRoute>}>
      ...
      <Route path="pedidos/:id" element={<PedidoDetalleAdminPage />} />
...
function AppLayout() {
  ...
  return <div className="store-theme">
    <Navbar />
    ...
    <Routes>
      ...
      {ENABLE_CHECKOUT && <Route path="/mis-pedidos" element={<ProtectedRoute><MisPedidosPage /></ProtectedRoute>} />}
      {ENABLE_CHECKOUT && <Route path="/mis-pedidos/:id" element={<ProtectedRoute><PedidoDetallePage /></ProtectedRoute>} />}
