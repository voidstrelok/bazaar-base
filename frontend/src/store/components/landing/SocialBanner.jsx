import { STORE_INSTAGRAM, STORE_FACEBOOK, STORE_TWITTER, STORE_WHATSAPP } from '../../../shared/utils/storeConfig';
          ...
          <div className="flex items-center gap-6">
            {STORE_INSTAGRAM && (
              <a
                ...
                className="text-black hover:text-black/70 transition-colors font-semibold flex items-center gap-1"
            ...
            {STORE_FACEBOOK && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:text-black/70 transition-colors font-semibold"
                aria-label="Facebook"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24">
